    ...
    while(1)
    {
        ...
        if(chr == '\n' || chr == '\r' || i == LENTHBUFFER - 1)
        {
            ...
            else if(strcmp("?", buffer) == 0)
            {
                ...
                //encoder_sig :> en;
                //strcpy(msg.data, "OK: ?" + "Left: " + en.left + "Right: " + en.right);
                strcpy(msg.data, "OK: ?");
                strcat(msg.data, "  Left: " + en.left);
                //strcat(msg.data, en.left);
                strcat(msg.data, "Right: " +  en.right);
                //strcat(msg.data, en.right);
