            ...
            if(chr == '\n' || chr == '\r' || i == LENTHBUFFER - 1)
            {
                ...
                else if(strcmp(".", buffer) == 0)
                {
                    ...
                    while(1)
                    {
                        ...
                        //dmp_out :> yprMsg;
                        //right y: -0.910217  p: 0.083196  r: 0.049776
                        /*
                        if(abs(currentYaw - yprMsg.y) == 1.57)  //1.6
                        {
                            stop(out_motor);
                            break;
                        }
                        */
                        ...
                        /*
                        if(currentYaw > 0 && yprMsg.y < 0)
                        {
                            if(abs(currentYaw + yprMsg.y) >= 0.5)
                            {
                                printf("y = %f\n", yprMsg.y);
                                stop(out_motor);
                                break;
                        ...
                        else if(abs(currentYaw - yprMsg.y) >= 1.57)  //1.6
                        {
                            printf("y = %f\n", yprMsg.y);
                            stop(out_motor);
                            break;
